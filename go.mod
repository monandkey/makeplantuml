...
replace (
	...
	local.packages/diameter => ./pkg/protocol/diameter
	local.packages/gtpv2 => ./pkg/protocol/gtpv2
	local.packages/ngap => ./pkg/protocol/ngap
	local.packages/pfcp => ./pkg/protocol/pfcp
...
require (
	...
	local.packages/diameter v0.0.0-00010101000000-000000000000 // indirect
	...
	local.packages/pfcp v0.0.0-00010101000000-000000000000 // indirect
